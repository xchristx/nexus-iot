...
- "luz": Luz. GPIO 2, se activa con nivel HIGH. LED integrado de la placa.
...
Las entradas ("t", "h") van como números decimales. Las salidas ("bomba", "vent", "luz") van como 1 (encendida) o 0 (apagada). Los nombres son exactamente esos, sin
...
{"ok": true,
 "cmd": ["bomba=1"],
 "reglas": [{"salida": "bomba", "entrada": "t", "condicion": ">", "umbral": 28, "hist": 1.5}],
 "avisos": []}
```
...
```json
{"salida": "bomba", "entrada": "t", "condicion": ">", "umbral": 28, "hist": 1.5}
```
